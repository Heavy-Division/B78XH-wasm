...
10. Select the build path of the wasm repo by right clicking the top level .sln file in the IDE file explorer, and selecting `preferences`. In the C++ output path option select your `B78XH-dev` folder and set the path to `B78XH-dev/SimObjects/Airplanes/Asobo_B787/panel/`
